...
// rescan request.
func (w *Wallet) activeData(dbtx walletdb.ReadWriteTx) ([]bronutil.Address, []wtxmgr.Credit, error) {
...
func (w *Wallet) newChangeAddress(addrmgrNs walletdb.ReadWriteBucket,
	account uint32, scope waddrmgr.KeyScope) (bronutil.Address, error) {
...
func (w *Wallet) SendOutputs(outputs []*wire.TxOut, account uint32,
	minconf int32, satPerKb bronutil.Amount, label string) (*wire.MsgTx, error) {
...
func (w *Wallet) publishTransaction(tx *wire.MsgTx) (*chainhash.Hash, error) {
	...
	// https://github.com/brocoin/brocoin/blob/0.20/src/validation.cpp#L642
