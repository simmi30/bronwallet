...
var (
	btcdDefaultCAFile  = filepath.Join(bronutil.AppDataDir("brond", false), "rpc.cert")
...
type config struct {
	...
	// RPC client options
	RPCConnect       string                  `short:"c" long:"rpcconnect" description:"Hostname/IP and port of brond RPC server to connect to (default localhost:8360, testnet: localhost:18740, simnet: localhost:18556)"`
	...
	BtcdUsername     string                  `long:"btcdusername" description:"Username for brond authentication"`
	BtcdPassword     string                  `long:"btcdpassword" default-mask:"-" description:"Password for brond authentication"`
	...
	Username               string                  `short:"u" long:"username" description:"Username for legacy RPC and brond authentication (if btcdusername is unset)"`
	Password               string                  `short:"P" long:"password" default-mask:"-" description:"Password for legacy RPC and brond authentication (if btcdpassword is unset)"`
