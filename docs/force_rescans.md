...
bronwallet will not drop transaction history by itself, as this is something that
...
```
$ cd $GOPATH/src/github.com/brsuite/bronwallet/cmd/dropwtxmgr
$ go get
```
...
```
$ dropwtxmgr
Database path: /home/username/.bronwallet/mainnet/wallet.db
Drop all bronwallet transaction history? [y/N] y
...
```
$ dropwtxmgr --db ~/.bronwallet/testnet/wallet.db
Database path: /home/username/.bronwallet/testnet/wallet.db
Drop all bronwallet transaction history? [y/N] y
Dropping wtxmgr namespace
```

After dropping transaction history, bronwallet may be restarted and a full rescan
